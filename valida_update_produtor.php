...
<head>
    ...
    <title>Atualização do Produtor</title>
</head>
...
$sql = "UPDATE produtor SET pro_nome='".$nome."', pro_morada='".$morada."', pro_telefone='".$telefone."', pro_email='".$email."', fk_reg_idRegiao='".$fk."'  WHERE pro_idProdutor = '".$id."'";
