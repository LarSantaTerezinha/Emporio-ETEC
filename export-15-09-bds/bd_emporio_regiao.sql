...
CREATE TABLE `regiao` (
  `reg_idRegiao` int NOT NULL AUTO_INCREMENT,
  `reg_desig` varchar(255) NOT NULL,
  PRIMARY KEY (`reg_idRegiao`)
...
INSERT INTO `regiao` VALUES (1,'Douro'),(2,'Alentejo'),(3,'Dão'),(4,'Vinho Verde'),(5,'Estremadura'),(6,'Bairrada');
